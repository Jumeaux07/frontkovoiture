                            ...
                            <div class="row">
                                ...
                                <div class="single-offers">
                                    ...
                                    <div class="offer-text">
                                        ...
                                        <h4>50.00 FCFA<span>/ jour</span></h4>
                                        <ul>
                                            <li><i class="fa fa-car"></i>Model:2017</li>
                                            <li><i class="fa fa-cogs"></i>Automatic</li>
                                            <li><i class="fa fa-dashboard"></i>20km/h</li>
                                        </ul>
                                        <div class="offer-action">
                                            <a href="#" class="offer-btn-1">Location</a>
                                ...
                                <div class="single-offers">
                                    ...
                                    <div class="offer-text">
                                        ...
                                        <h4>75.00 FCA<span>/ jour</span></h4>
                                        <ul>
                                            <li><i class="fa fa-car"></i>Model:2017</li>
                                            <li><i class="fa fa-cogs"></i>Automatic</li>
                                            <li><i class="fa fa-dashboard"></i>20km/h</li>
                                ...
                                <div class="single-offers">
                                    ...
                                    <div class="offer-text">
                                        ...
                                        <h4>45.00 FCA<span>/ jour</span></h4>
                                        <ul>
                                            <li><i class="fa fa-car"></i>Model:2017</li>
                                            <li><i class="fa fa-cogs"></i>Automatic</li>
                                            <li><i class="fa fa-dashboard"></i>20km/h</li>
                                        ...
                                        <div class="offer-action">
                                            <a href="#" class="offer-btn-1">Vente</a>
                                            <a href="#" class="offer-btn-2">Details</a>
                                        </div>
                                    </div>
                                </div>
